...
/**
 * Convenience wrapper to store system state data, including location information, action command,
 * state data and a list of the following data items:
 *
...
public class SystemStateData extends BaseIotData implements Serializable {
  ...
  /**
   * Returns a string representation of this instance. This will invoke the base class {@link
   * #toString()} method, then append the output from this call.
   *
  ...
  public String toString() {
    ...
    sb.append(ConfigConst.SENSOR_DATA_LIST_PROP)
        .append('=')
        .append(this.getSensorDataList())
        .append(',');
    sb.append(ConfigConst.SYSTEM_PERF_DATA_LIST_PROP)
        .append('=')
        .append(this.getSystemPerformanceDataList());
  ...
  protected void handleUpdateData(BaseIotData data) {
    if (data instanceof SystemStateData) {
      ...
      this.command = ssData.getCommand();
