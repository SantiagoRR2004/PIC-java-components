...
public interface ICloudClient {
	...
	/**
	 * Attempts to send the given data instance to the remote cloud service. This
	 * will default to the pre-configured QoS level set in the configuration for the
	 * cloud service, and use the underlying implementation to
	 * 
	 * @param resource
	 *            The resource enum to use for this send request.
	 * @param data
	 *            The data instance to publish to the remote cloud service.
	 * @return bool True on success, False otherwise.
	 */
	...
	/**
	 * Attempts to subscribe to events destined for edge consumption that are sent
	 * by the remote cloud service.
	 * 
	 * @param resource
	 *            The resource enum to use for this subscribe request.
	 * @return bool True on success, False otherwise.
	 */
