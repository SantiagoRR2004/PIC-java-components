...
public class GenericCoapResponseHandler implements CoapHandler {
  ...
  public GenericCoapResponseHandler(IDataMessageListener listener) {
    ...
    _Logger.info(
        "Response handler created. IDataMessageListener is "
  ...
  public void onLoad(CoapResponse response) {
    if (response != null) {
      ...
      // _Logger.finest("Processing CoAP response. MID: " +
      // response.advanced().getMID());
      // _Logger.finest("Processing CoAP response. Token: " +
      // response.advanced().getTokenString());
