...
public class DeviceDataManager extends JedisPubSub implements IDataMessageListener {
	...
	public DeviceDataManager() {
		...
		this.humidityMaxTimePastThreshold =
			...
			ConfigConst.GATEWAY_DEVICE,ConfigConst.HUMIDIFIER_MAX_TIME_KEY);
			
		this.nominalHumiditySetting =
			configUtil.getFloat(
			ConfigConst.GATEWAY_DEVICE,ConfigConst.IDEAL_HUMIDITY_KEY);
			
		this.triggerHumidifierFloor =
			configUtil.getFloat(
			ConfigConst.GATEWAY_DEVICE,ConfigConst.HUMIDIFIER_FLOOR_KEY);
			
		this.triggerHumidifierCeiling =
			configUtil.getFloat(
			ConfigConst.GATEWAY_DEVICE,ConfigConst.HUMIDIFIER_CEILING_KEY);
