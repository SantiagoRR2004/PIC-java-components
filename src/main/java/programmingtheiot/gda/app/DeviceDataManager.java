...
public class DeviceDataManager extends JedisPubSub implements IDataMessageListener {
  ...
  public void startManager() {
    ...
    if (this.persistenceClient != null) {
      ...
      if (this.persistenceClient instanceof RedisPersistenceAdapter) {
        ((RedisPersistenceAdapter) this.persistenceClient)
            .subscribeToChannel(this, ResourceNameEnum.CDA_SENSOR_MSG_RESOURCE);
      }
    }
  }
  ...
  private boolean handleUpstreamTransmission(
      ResourceNameEnum resourceName, String jsonData, int qos) {
