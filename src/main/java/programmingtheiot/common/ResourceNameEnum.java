...
/**
 * A convenience class to provide type consistency around commonly used topics and resource names.
 */
public enum ResourceNameEnum {
  ...
  /**
   * Convenience method for looking up an enum type based on the value String. If the lookup fails,
   * null will be returned.
   *
   * <p>No error or warning message will be logged, and no exception will be thrown. If this is
   * called and null is returned, it's safe to assume that the value simply does not map to any of
   ...
   * @param isObservable
   */
  private ResourceNameEnum(
      String productName,
      String deviceName,
      String resourceType,
      boolean isLocalToGda,
  ...
  /**
   * @return List<String> The ordered list of Strings representing this resource name split by '/'.
   */
  ...
  /**
   * @return boolean True if this resource is local to the GDA (meaning any use of the resource is
   *     internal to the GDA); false if it's not (meaning it's a resource used by the CDA).
   */
  ...
  /**
   * @return boolean True if this resource should be treated as observable; false otherwise.
   */
