...
/**
 * This class contains various constants and default values that represent config file sections,
 * keys, and other properties that are useful for consistent system operation.
 */
public class ConfigConst {
  ...
  public static final String AWS_CLOUD_GATEWAY_SERVICE =
      CLOUD + "." + GATEWAY_SERVICE + "." + AWS_CLOUD_SVC_NAME;
  public static final String AZURE_CLOUD_GATEWAY_SERVICE =
      CLOUD + "." + GATEWAY_SERVICE + "." + AZURE_CLOUD_SVC_NAME;
  public static final String GCP_CLOUD_GATEWAY_SERVICE =
      CLOUD + "." + GATEWAY_SERVICE + "." + GCP_CLOUD_SVC_NAME;
  public static final String UBIDOTS_CLOUD_GATEWAY_SERVICE =
      CLOUD + "." + GATEWAY_SERVICE + "." + UBIDOTS_CLOUD_SVC_NAME;
  ...
  public static final String FILE_DATA_GATEWAY_SERVICE =
      DATA + "." + GATEWAY_SERVICE + "." + FILE_DATA_SVC_NAME;
  public static final String INFLUX_DATA_GATEWAY_SERVICE =
      DATA + "." + GATEWAY_SERVICE + "." + INFLUX_DATA_SVC_NAME;
  public static final String REDIS_DATA_GATEWAY_SERVICE =
      DATA + "." + GATEWAY_SERVICE + "." + REDIS_DATA_SVC_NAME;
