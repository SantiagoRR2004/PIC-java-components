...
/**
 * This test case class contains very basic unit tests for SystemStateData. It should not be
 * considered complete, but serve as a starting point for the student implementing additional
 * functionality within their Programming the IoT environment.
 */
public class SystemStateDataTest {
  // static

  private static final Logger _Logger = Logger.getLogger(SystemStateDataTest.class.getName());
  ...
  /**
   * NOTE: SystemStateData is not required for the exercises in Programming the IoT. The test cases
   * below are disabled by default, but can easily be re-enabled by uncommenting the @Test attribute
   * if SystemStateData is optionally implemented.
   */
