...
/**
 * This test case class contains very basic unit tests for SensorData. It should not be considered
...
public class SensorDataTest {
  ...
  public void testDifferentDataInstanceUpdate() {
    ...
    spd.setDiskUtilization((float) 33.3);
    spd.setNetInUtilization((float) 44.4);
    spd.setNetOutUtilization((float) 55.5);
