...
/**
 * This test case class contains very basic unit tests for DataUtil. It should not be considered
...
public class DataUtilTest {
  ...
  private static final Logger _Logger = Logger.getLogger(DataUtilTest.class.getName());
  ...
  /**
   * NOTE: SystemStateData is not required for the exercises in Programming the IoT. The test case
   * below is disabled by default, but can easily be re-enabled by uncommenting the @Test attribute
