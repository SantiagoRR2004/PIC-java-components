...
/**
 * This test case class contains very basic integration tests for DataUtil and data container
 * classes for use between the CDA and GDA to verify JSON compatibility. It should not be considered
...
public class DataIntegrationTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    _CdaDataPath =
        ConfigUtil.getInstance()
            .getProperty(ConfigConst.GATEWAY_DEVICE, ConfigConst.TEST_CDA_DATA_PATH_KEY);
    _GdaDataPath =
        ConfigUtil.getInstance()
            .getProperty(ConfigConst.GATEWAY_DEVICE, ConfigConst.TEST_GDA_DATA_PATH_KEY);
  ...
  public void testWriteSystemPerformanceDataToGdaDataPath() {
    ...
    try {
      Path filePath = FileSystems.getDefault().getPath(fileName);
      String dataStr =
          DataUtil.getInstance().systemPerformanceDataToJson(new SystemPerformanceData());
