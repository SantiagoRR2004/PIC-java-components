...
/**
 * This test case class contains very basic integration tests for CoapClientConnector. It should not
 ...
 *
 * <p>NOTE: The CoAP server must be running before executing these tests.
 */
public class CoapClientPerformanceTest {
  ...
  private void execTestPut(int maxTestRuns, boolean enableCON) {
    ...
    _Logger.info(
        "PUT message - useCON = " + enableCON + " [" + maxTestRuns + "]: " + elapsedMillis + " ms");
  }
}
