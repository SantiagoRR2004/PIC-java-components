...
/**
 * This test case class contains very basic integration tests for MqttClientConnector. It should not
 ...
 *
 * <p>IMPORTANT NOTE: This test expects MqttClientConnector to be configured using the synchronous
 * MqttClient.
 */
public class MqttClientConnectorTest {
   ...
   * programmingtheiot.gda.connection.MqttClientConnector#publishMessage(programmingtheiot.common.ResourceNameEnum,
  ...
  public void testPublishAndSubscribe() {
    ...
    assertTrue(
        this.mqttClient.publishMessage(
            ...
            "TEST: This is the GDA message payload 1.",
            qos));
    assertTrue(
        this.mqttClient.publishMessage(
            ResourceNameEnum.GDA_MGMT_STATUS_MSG_RESOURCE,
            "TEST: This is the GDA message payload 2.",
            qos));
    assertTrue(
        this.mqttClient.publishMessage(
            ResourceNameEnum.GDA_MGMT_STATUS_MSG_RESOURCE,
            "TEST: This is the GDA message payload 3.",
            qos));
  ...
  public void testPublishAndSubscribeTwoClients() {
    ...
    IDataMessageListener listener =
        new MqttPublishDataMessageListener(ResourceNameEnum.GDA_MGMT_STATUS_CMD_RESOURCE, true);
  ...
  public void testIntegrateWithCdaPublishCdaCmdTopic() {
    ...
    assertTrue(
        this.mqttClient.publishMessage(
            ...
            "TEST: This is the CDA command payload.",
            qos));
  ...
  public void testIntegrateWithCdaSubscribeCdaMgmtTopic() {
    ...
    assertTrue(this.mqttClient.connectClient());
    assertTrue(
        this.mqttClient.subscribeToTopic(ResourceNameEnum.CDA_MGMT_STATUS_MSG_RESOURCE, qos));
