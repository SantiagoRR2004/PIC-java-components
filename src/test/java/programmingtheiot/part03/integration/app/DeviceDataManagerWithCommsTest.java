...
/**
 * This test case class contains very basic integration tests for DeviceDataManager. It should not
...
public class DeviceDataManagerWithCommsTest {
   ...
   *
   * <p>def testStartAndStopManagerWithMqtt(self):
   *
   * <p>def testStartAndStopManagerWithCoap(self):
   *
   * <p>def testStartAndStopManagerWithMqttAndCoap(self):
   */
}
