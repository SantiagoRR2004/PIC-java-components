...
/**
 * This test case class contains very basic unit tests for SimpleCertManagementUtil. It should not
 * be considered complete, but serve as a starting point for the student implementing additional
 * functionality within their Programming the IoT environment.
 */
public class SimpleCertManagementUtilTest {
  ...
  /**
   * NOTE: Copy a valid cert into the given file name, and uncomment the @Test annotation before
   * {@link #testImportOfCertFromValidFile} to test.
   */
  ...
  // public static final String TEST_VALID_CERT_FILE = DIR_PREFIX +
  // "test_cert_validA.pem";
  ...
  /**
   * Tests {@link SimpleCertManagementUtil} with a certificate file containing one or more
   * certificates.
   *
   * <p>NOTE: To use this test, uncomment @Test and replace "path/to/validcertfile" with an actual,
   * valid server certificate. Certificates and sensitive information should NEVER be committed to
   * your source tree.
   */
  // @Test
  ...
  /**
   * Tests {@link SimpleCertManagementUtil} with an invalid certificate file containing only the
   * BEGIN / END entries.
   */
  @Test
  ...
  /**
   * Tests {@link SimpleCertManagementUtil} with an invalid certificate file containing invalid
   * text.
   */
  @Test
