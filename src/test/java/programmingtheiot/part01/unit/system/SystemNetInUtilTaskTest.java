...
/**
 * This test case class contains very basic unit tests for SystemNetInUtilTaskTest. It should not be
...
public class SystemNetInUtilTaskTest {
  ...
  private static final Logger _Logger = Logger.getLogger(SystemNetInUtilTaskTest.class.getName());
