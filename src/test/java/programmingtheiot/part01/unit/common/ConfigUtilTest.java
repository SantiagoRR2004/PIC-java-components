...
/**
 * This test case class contains very basic unit tests for ConfigUtil. It should
...
public class ConfigUtilTest {
	...
	public void testGetBooleanProperty() {
		String enableLogging = ConfigUtil.getInstance().getProperty(ConfigConst.GATEWAY_DEVICE,
	...
	/**
	 * Test method for
	 * {@link com.labbenchstudios.edu.connecteddevices.common.ConfigUtil#getIntegerProperty(java.lang.String, java.lang.String)}.
	 */
	@Test
	public void testGetIntegerProperty() {
		String portStr = ConfigUtil.getInstance().getProperty(ConfigConst.MQTT_GATEWAY_SERVICE, ConfigConst.PORT_KEY);
	...
	/**
	 * Test method for
	 * {@link com.labbenchstudios.edu.connecteddevices.common.ConfigUtil#loadConfig(java.lang.String)}.
	 */
	@Test
	public void testGetProperty() {
		String host = ConfigUtil.getInstance().getProperty(ConfigConst.MQTT_GATEWAY_SERVICE, ConfigConst.HOST_KEY);

		String credFile = ConfigUtil.getInstance().getProperty(ConfigConst.MQTT_GATEWAY_SERVICE,
	...
	/**
	 * Test method for
	 * {@link com.labbenchstudios.edu.connecteddevices.common.ConfigUtil#hasProperty(java.lang.String, java.lang.String)}.
	 */
	@Test
	public void testHasProperty() {
		assertTrue(
				ConfigUtil.getInstance().hasProperty(ConfigConst.MQTT_GATEWAY_SERVICE, ConfigConst.ENABLE_CRYPT_KEY));
	}

	/**
	 * Test method for
	 * {@link com.labbenchstudios.edu.connecteddevices.common.ConfigUtil#hasSection(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.labbenchstudios.edu.connecteddevices.common.ConfigUtil#isConfigDataLoaded()}.
	 */
	@Test
