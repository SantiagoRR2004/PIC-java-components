...
/**
 * This test case class contains very basic integration tests for CloudClientConnector. It should
...
public class CloudClientConnectorTest {
   ...
   * programmingtheiot.gda.connection.UbidotsMqttCloudClientConnector#connectClient()}.
   */
  // @Test
  ...
  /**
   * Test method for {@link
   * programmingtheiot.gda.connection.UbidotsMqttCloudClientConnector#publishMessage(programmingtheiot.common.ResourceNameEnum,
