...
/**
 * This test case class contains very basic integration tests for SmtpClientConnector. It should not
...
public class SmtpClientConnectorTest {
  ...
  public void testSendMessage() {
    ...
    assertTrue(
        this.smtpClient.sendMessage(
            ResourceNameEnum.GDA_MGMT_STATUS_MSG_RESOURCE, ssdJson, DEFAULT_TIMEOUT));
  }
}
